About docling-ibm-models-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/docling-ibm-models-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/docling-ibm-models-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add docling-ibm-models
# for installing globally
pixi global install docling-ibm-models
```
...
It is possible to list all of the versions of `docling-ibm-models` available on your platform:
...
```
pixi search docling-ibm-models --channel conda-forge
```
